...
leapAmberFile = 'oldff/leaprc.ff99SB'
...
a        """
 ...
 %s -pf y %s' % (self.acExe, self.inputFile, exten, self.acMol2FileName,
    ...
    def execTleap(self):
        ...
        if self.execParmchk2():
            self.printError("Parmchk2 failed")
            fail = True
            # sys.exit(1)
    ...
    def execParmchk2(self):

        self.makeDir()
        cmd = '%s -i %s -f mol2 -o %s' % (self.parmchk2Exe, self.acMol2FileName,
        ...
        self.parmchk2Log = _getoutput(cmd)
        ...
        if os.path.exists(self.acFrcmodFileName):
            ...
            if check:
                ...
                self.printMess("* Parmchk2 OK *")
        else:
            self.printQuoted(self.parmchk2Log)
            return True
...
class ACTopol(AbstractTopol):
    ...
    def __init__(self, inputFile, chargeType='bcc', chargeVal=None,
        ...
        self.parmchk2Exe = _getoutput('which parmchk2') or ''
